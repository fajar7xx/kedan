...
?>	
			...
			<div class="footer-area">
				...
				<div class="footer-top">
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 footer-right-col">
								<!-- Footer Right -->
								<div class="footer-right">
									<div class="footer-newsletter">
										<form action="#">
											<h2>Newsletter</h2>
											<input type="text" title="Sign up for our newsletter" placeholder="Alamat Email Anda.." required>
				...
				<div class="footer-bottom">
					<div class="container">
						<!-- Copyright -->
						<div class="copyright">
							<p>Copyright &copy; <a href="http://betaproject.id" target="_blank">Project Beta</a> All Rights Reserved.</p>
						</div>
					</div>
		...
		<!-- Simple Lence JS
		============================================ -->
		<script type="text/javascript" src="theme/js/jquery.simpleGallery.min.js"></script>
		<script type="text/javascript" src="theme/js/jquery.simpleLens.min.js"></script>	
		<!-- owl.carousel JS
		============================================ -->		
		...
		<!-- jquery Collapse JS
		============================================ -->
        <script src="theme/js/jquery.collapse.js"></script>
		<!-- plugins JS
		============================================ -->		
